...
var Tips = (function (_React$Component2) {
	...
	_createClass(Tips, [{
		...
		value: function render() {
			...
			return _react2['default'].createElement(
				Modal,
				_extends({ className: (0, _classnames2['default'])(_styleModalStyl2['default'].tips, this.props.className), autoClose: props.duration || 2000 }, props),
				props.msg
			);
		}
	}]);
...
var Dialog = (function (_React$Component3) {
	...
	_createClass(Dialog, [{
		...
		value: function render() {
			...
			return _react2['default'].createElement(
				Modal,
				_extends({ className: (0, _classnames2['default'])(_styleModalStyl2['default'].dialog, this.props.className) }, props),
				titleEl,
				msgEl,
				_react2['default'].createElement(
					'footer',
